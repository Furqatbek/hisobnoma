...
/**
 * Partial update: only non-null scalar fields are applied. When {@code territories}
 * is non-null it fully replaces the agent's existing territory set; null leaves it untouched.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class UpdateDistributionAgentRequest {
