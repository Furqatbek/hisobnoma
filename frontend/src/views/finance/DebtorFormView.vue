...
function moveLineUp(index) {
  if (index <= 0) return
  const item = form.lines.splice(index, 1)[0]
  form.lines.splice(index - 1, 0, item)
}
                  ...
                  <td class="px-1 py-2">
                    <div class="flex flex-col items-center">
                      <button
                        ...
                        :disabled="index === 0"
                        class="p-0.5 rounded hover:bg-gray-100 disabled:opacity-20 disabled:cursor-not-allowed"
                      >
