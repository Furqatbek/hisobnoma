...
/**
 * Event published when stock is issued/deducted from inventory.
 * This includes sales, stock-out, and manual deductions.
 */
@Getter
public class StockIssuedEvent extends InventoryEvent {
    ...
    public StockIssuedEvent(Object source, Long tenantId, Long productId, String productSku, String productName,
    ...
    /**
     * Builder for creating StockIssuedEvent instances.
     */
    ...
    public static class Builder {
        ...
        public StockIssuedEvent build() {
            return new StockIssuedEvent(source, tenantId, productId, productSku, productName,
                    locationId, locationCode, locationName, quantity, unitCost,
                    quantityBefore, quantityAfter, referenceType, referenceId, referenceNumber, reason, batchNumber);
        }
    }
}
